        ...
        child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
          ...
          Center(child: Column(children: [
            Container(
              ...
              child: Center(child: Text(initial, style: AppTextStyles.displayMedium.copyWith(color: AppColors.white))),
            ),
          ...
          Row(children: [
            ...
            _StatCard(label: 'Net Balance', value: AppFormatters.currency(totalBalance), icon: Icons.account_balance_wallet_outlined, color: totalBalance >= 0 ? AppColors.income : AppColors.expense),
          ]),
          const SizedBox(height: 12),
          Row(children: [
          ...
          AppCard(child: Column(children: [
            _SettingsRow(icon: Icons.notifications_outlined, label: 'Notifications', trailing: Switch(value: false, onChanged: (_) {}, activeColor: AppColors.primary)),
  ...
  void _showAbout(BuildContext context) {
    showDialog(
      ...
      builder: (ctx) => AlertDialog(
        ...
        content: Text('Version 1.0.0\nBuilt with Flutter + Supabase\n\nTrack income and expenses across multiple accounts.', style: AppTextStyles.bodyMedium),
    ...
    return Expanded(
      child: Container(
        ...
        child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
          ...
          Text(value, style: AppTextStyles.amountMedium.copyWith(fontSize: 14, color: AppColors.ink900), maxLines: 1, overflow: TextOverflow.ellipsis),
        ]),
      ),
    );
  }
    ...
    return InkWell(
      ...
      child: Padding(
        ...
        child: Row(children: [
          ...
          Expanded(child: Text(label, style: AppTextStyles.bodyMedium.copyWith(color: AppColors.ink900))),
