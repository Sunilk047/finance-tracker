...
class _AddAccountSheetState extends State<AddAccountSheet> {
  ...
  void _create() {
    ...
    context.read<AccountsBloc>().add(AccountsEvent.accountsCreateRequested(name: _nameCtrl.text.trim(), colorIndex: _color));
          ...
          child: Form(
            ...
            child: Column(
              ...
              children: [
                ...
                Row(
                  children: List.generate(AppColors.accountChips.length, (i) {
                    final sel = i == _color;
                    return GestureDetector(
                      ...
                      child: AnimatedContainer(
                        ...
                        height: 32,
                        decoration: BoxDecoration(
                          color: AppColors.accountChips[i],
