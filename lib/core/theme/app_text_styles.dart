...
abstract class AppTextStyles {
  ...
  static const amountHero   = TextStyle(fontSize: 36, fontWeight: FontWeight.w700, letterSpacing: -1.0, color: AppColors.ink900, fontFamily: 'monospace');
  static const amountLarge  = TextStyle(fontSize: 20, fontWeight: FontWeight.w700, letterSpacing: -0.5, color: AppColors.ink900, fontFamily: 'monospace');
