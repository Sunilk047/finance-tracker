          ...
          pw.Container(
            ...
            child: pw.Column(
              ...
              children: [
                ...
                pw.Text(
                  '${account.name} · Exported on $dateStr',
          ...
          pw.Table(
            ...
            children: [
              pw.TableRow(
                ...
                children: ['Title', 'Amount', 'Type', 'Date']
                    .map(
                      (h) => pw.Padding(
              ...
              ...transactions.map((tx) {
                ...
                return pw.TableRow(
                  children: [
                    pw.Padding(
                      padding: const pw.EdgeInsets.all(8),
                      child: pw.Text(tx.title, style: pw.TextStyle(font: font, fontSize: 9)),
                    ),
                    pw.Padding(
                      padding: const pw.EdgeInsets.all(8),
                      child: pw.Text(
                        '${tx.isIncome ? '+' : '-'}₹${tx.amount.toStringAsFixed(2)}',
                        style: pw.TextStyle(font: fontBold, fontSize: 9, color: c),
                      ),
                    ),
                    pw.Padding(
                      padding: const pw.EdgeInsets.all(8),
                    ...
                    pw.Padding(
                      padding: const pw.EdgeInsets.all(8),
                      child: pw.Text(DateFormat('dd MMM yyyy').format(tx.createdAt), style: pw.TextStyle(font: font, fontSize: 9)),
                    ),
                  ],
                );
              }),
